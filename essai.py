...
#"Callback quand le joueur a entré un nombre."
    ...
    if nombre_secret > nbre_choisi:
    ...
    else:#On enlève les éléments dont on n'a plus besoin
        lbl_reponse.destroy()
        reponse.destroy()
        ...
        resultat.config(text="Tu as trouvé le nombre. Bravo!", font=("", 12), fg="green")
app = tk.Tk()
titre = tk.Label(app, text="Devine le nombre auquel je pense",
font=("", 16))
titre.grid(row=0, columnspan=2, pady=8)
nombre_secret = randint(0, 100) + 1
lbl_reponse = tk.Label(app,
text="Choisi un nombre entre 1 et 100 inclus:")
